...
export type ResourceModuleKey = 'basic-info' | 'project-details'
...
/** Editable Basic Info fields (resource name is locked after create). */
export type EditableBasicInfo = Omit<BasicInfoUpdatePayload, 'resourceName'>
