...
/** Frontend completeness for UX progress — backend remains authoritative. */
...
/**
 * Draft sequencing: Project Details stays locked until Basic Info is complete.
 * Completed resources are never locked by this rule.
 */
